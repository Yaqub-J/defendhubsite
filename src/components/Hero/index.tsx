            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                <h1 className="mb-5 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
                  Empowering Businesses With Tech-Driven Solutions.
                </h1>
                <p className="mb-12 text-base !leading-relaxed text-body-color dark:text-body-color-dark sm:text-lg md:text-xl">
                  At DefendHub, we specialize in delivering innovative, AI-driven driven solutions tailored to enhance businesses in a rapidly evolving digital world. With a strong network of partners and a commitment to excellence, we’re here to safeguard your success.
                </p>
